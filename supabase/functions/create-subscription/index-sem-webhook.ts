...
// const WEBHOOK_URL = Deno.env.get('MERCADOPAGO_WEBHOOK_URL')! // ⚠️ COMENTADO
...
serve(async (req) => {
  ...
  try {
    ...
    const subscriptionData = {
      ...
      // ⚠️ NOTIFICATION_URL REMOVIDO TEMPORARIAMENTE PARA TESTE
      // notification_url: WEBHOOK_URL,
    }

    console.log('🚀 Enviando para Mercado Pago...')
    console.log('📋 Dados enviados:', JSON.stringify(subscriptionData, null, 2))
    console.log('⚠️ TESTE SEM WEBHOOK - notification_url removido')
