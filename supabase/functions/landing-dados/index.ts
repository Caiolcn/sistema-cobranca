  ...
  try {
    ...
    const { data: empresa, error: empresaError } = await supabase
      ...
      .select(`
        ...
        landing_youtube_url, landing_youtube_titulo, landing_youtube_descricao,
    ...
    return new Response(
      JSON.stringify({
        empresa: {
          ...
          youtube_url: empresa.landing_youtube_url || null,
          youtube_titulo: empresa.landing_youtube_titulo || null,
          youtube_descricao: empresa.landing_youtube_descricao || null,
          ordem_secoes: Array.isArray(empresa.landing_ordem_secoes) && empresa.landing_ordem_secoes.length > 0
            ...
            : ['sobre','planos','galeria','horarios','depoimentos','faq','youtube','mapa'],
          ...
          mostrar_youtube: empresa.landing_mostrar_youtube !== false,
