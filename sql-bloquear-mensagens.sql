-- =====================================================
-- BLOQUEAR MENSAGENS POR ALUNO
-- Permite pausar cobranças para alunos específicos.
-- =====================================================

-- 1. Adicionar coluna
ALTER TABLE devedores
ADD COLUMN IF NOT EXISTS bloquear_mensagens BOOLEAN DEFAULT false;

COMMENT ON COLUMN devedores.bloquear_mensagens IS 'Se true, nenhuma mensagem automática será enviada para este aluno.';

-- =====================================================
-- 2. Recriar views com filtro de bloquear_mensagens + lixo
-- =====================================================

-- VIEW 1: Parcelas com vencimento em 3 DIAS
...
WHERE (
    ...
    OR (EXTRACT(DOW FROM CURRENT_DATE) = 1 AND c.enviar_domingo = false
...
-- VIEW 3: Parcelas com 3 DIAS DE ATRASO
